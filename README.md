...
The aim of this project is to evaluate transfer learning-based convolutional neural networks for classifying immune cell types from H&E-stained blood microscopy images.
